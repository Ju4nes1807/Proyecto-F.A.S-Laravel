  ...
  <div class="navbar navbar-expand-md bg-primary shadow mb-4">
    ...
    <div class="collapse navbar-collapse" id="navNavbarDropdown">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a href="{{ route('entrenador.perfil.edit') }}" class="nav-link text-light shadow">Perfil</a>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="container-fluid flex-grow-1">
    <div class="row">
      ...
      <main class="col-md-9 col-lg-10 p-4">
        <h2 class="mb-3">✏️ Editar Entrenamiento</h2>

        <div class="card shadow-sm border-warning">
          <div class="card-body">
            <form method="POST" action="{{ route('entrenador.entrenamientos.update', $entrenamiento) }}">
              @csrf
              @method('PUT')
