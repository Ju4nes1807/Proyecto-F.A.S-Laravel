    ...
    <div class="navbar navbar-expand-md bg-primary shadow mb-4">
        ...
        <div class="collapse navbar-collapse" id="navNavbarDropdown">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a href="{{ route('entrenador.perfil.edit') }}" class="nav-link text-light shadow">Modificar
                        Perfil</a>
                </li>
            </ul>
        </div>
            ...
            <div class="col-12 col-md-9 col-lg-10 p-4">
                ...
                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between mb-3">
                    <form class="d-flex flex-grow-1 mb-2 mb-md-0 me-md-2" role="search" method="GET"
                        ...
                        <a href="{{ route('entrenador.torneos') }}" class="btn btn-outline-warning ms-1"><i
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center">No hay torneos asignados a tu escuela.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
