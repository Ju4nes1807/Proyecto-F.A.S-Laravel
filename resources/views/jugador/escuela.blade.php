  ...
  <div class="navbar navbar-expand bg-primary shadow mb-4">
    ...
    <div class="collapse navbar-collapse" id="navNavbarDropdown">
      <ul class="navbar-nav ms-auto">
        <li class="nav-item">
          <a href="{{ route('jugador.perfil') }}" class="nav-link text-light shadow">Mi Perfil</a>
        </li>
        <li class="nav-item">
    ...
    <div class="row">
      ...
      <div class="col-md-3 col-lg-2 sidebar">
        ...
        <div class="list-group">
          ...
          <a href="{{ url('torneos.index') }}" class="list-group-item list-group-item-action">Torneos</a>
